...
export const UnitCard = ({
    ...
    return (
        <Link 
            to={`/unit/${id}`}
            className="w-1/4 flex flex-col flex-grow min-w-90 max-w-2xs md:flex-grow-0 md:w-1/6 mx-1 py-1 md:mx-2 md:py-2 px-2 md:px-0 bg-white rounded-2xl text-center mb-4 cursor-pointer w-2xs shadow"
        >
            <div 
